...
Método bisección primera raíz $f(x)=x^2-4x-21$
...
Método de newton primera raíz $f(x)=x^2-4x-21$

```{python}

#| code-fold: True 

der_f = lambda x: 2*x - 4
...
Método de la secante primera raíz $f(x)=x^2-4x-21$
...
Método bisección segunda raíz $f(x)=x^2-4x-21$
...
Método de newton segunda raíz $f(x)=x^2-4x-21$
...
Método de la secante segunda raíz $f(x)=x^2-4x-21$
...
Consideremos $f(x)=x^3-6x^2+5x+12$
...
Método de newton primera raíz $f(x)=x^3-6x^2+5x+12$

```{python}

#| code-fold: True 

der_f = lambda x: 3*x**2 - 12*x + 5
...
Método de la secante primera raíz $f(x)=x^3-6x^2+5x+12$
...
Método de newton segunda raíz $f(x)=x^3-6x^2+5x+12$
...
Método de la secante segunda raíz $f(x)=x^3-6x^2+5x+12$
...
Método de newton tercera raíz $f(x)=x^3-6x^2+5x+12$
...
Método de la secante tercera raíz $f(x)=x^3-6x^2+5x+12$
...
if f0*f1 < 0:
  ...
  print (f"La primera raíz es: {raiz_1_3}")
   ...
   print("No hay cambio de signo en el intervalo [0, 1]. Por lo que el método de bisección no puede aplicarse.")
```
...
raiz_2Vsecante, info_secante2V = optimize.newton(f2, x0 = 5, x1 = 6 , full_output = True)

print ("Información de la convergencia del método de la secante segunda raíz - Violeta")
print (info_secante2V)
print ("--------------------------------------")
print (f"La segunda raíz (Violeta) es {raiz_2Vsecante}")
...
Gráfica de curva de las curvas de nivel.
